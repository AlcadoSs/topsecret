// ==UserScript==
// @name         gladiatus Auto Scripts
// @version      3
// @description  Gladiatus
// @author       Top Secret
// @match        *://*.gladiatus.gameforge.com/game/index.php*
// @exclude      *://*.gladiatus.gameforge.com/game/index.php?mod=start
// @downloadURL  https://github.com/AlcadoSs/topsecret/raw/master/gladiatus-script.js
// @updateURL    https://github.com/AlcadoSs/topsecret/raw/master/gladiatus-script.js
// @grant        GM_addStyle
// @grant        GM_getResourceText
// @require      https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js
// @resource     customCSS_global  https://raw.githubusercontent.com/AlcadoSs/topsecret/master/global.css
// ==/UserScript==
...
(function () {
    ...
    settingsButton.innerHTML = `<img src="${assetsUrl}/cog.svg" title="Settings" height="20" width="20" style="filter: invert(83%) sepia(52%) saturate(503%) hue-rotate(85deg) brightness(103%) contrast(101%); z-index: 999;">`;
    ...
    function autoGo() {
            ...
            */
            ...
            if (eatFood) {
                ...
                if (!inOverviewPage) {
                    ...
                    if (activeTabBagNumber !== foodLocation) {
                        ...
                        clickTabByBagNumber(foodLocation);
                        setTimeout(function () {
                            $("#mainmenu a.menuitem")[0].click();
                        }, clickDelay * 1.5);
                    } else {
        ...
        if (!pauseToEat && !pauseToSaveGold && doQuests === true && (nextQuestTime < currentTime)) {
            ...
            function getIconName(url) {
                ...
                if (url.includes('icon_work_inactive')) {
                    return 'work';
                }
            ...
            function checkDungeonQuests() {
                ...
                for (const quest of activeQuests) {
                    if (quest.getElementsByClassName("quest_slot_icon")[0].style.backgroundImage.includes('icon_dungeon_inactive')) {
                        activeDungeonQuests++;
            ...
            function takeQuest() {
                ...
                if (canTakeQuest.length) {
                    function getExpeditionQuestType(quest) {
                        ...
                        if (questTitle.includes(areaExpedition) && questTitle.includes(enemyExpedition)) {
                            return 1;
                        } else {
                            return 0;
                        };
                    ...
                    function getDungeonQuestType(quest) {
                        ...
                        const questTitle = quest.getElementsByClassName("quest_slot_title")[0].innerText;
                        if (questTitle.includes(areaDungeon)) {
                            return 1;
                        } else {
                            return 0;
                        };
